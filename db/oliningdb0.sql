...
MySQL - 5.1.30-community : Database - olining
*********************************************************************
*/
...
insert  into `ci_sessions`(`session_id`,`ip_address`,`user_agent`,`last_activity`,`user_data`) values ('a3a521c08de6ec7e587647a731380953','192.168.0.77','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/54.0.2840.99 Safari/537.36',1481020666,''),('ff2522c29cd030e33c8888bd1e9d9650','192.168.0.71','Mozilla/5.0 (Macintosh; Intel Mac OS X 10_12_1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/54.0.2840.98 Safari/537.36',1481019438,'a:3:{s:9:\"user_data\";s:0:\"\";s:9:\"user_name\";s:5:\"admin\";s:12:\"is_logged_in\";b:1;}');
...
insert  into `sentences`(`sentences_id`,`s_en`,`s_zh-cn`,`s_ko`,`s_de`,`s_language`,`audio`,`image`,`editor_id`,`searched_count`,`reviewed_count`,`viewed_count`,`date`,`chapters_id`,`d_zh-CN`,`d_en`,`d_ko`,`d_de`,`d_language`) values (1,'That\'s a nice idea','',NULL,'','EN','c6ca9af7cc8636307d54d6431a36fc04.mp3','96578ff6428b63c2d3192bb8d20b3908.jpg',NULL,NULL,NULL,NULL,'2016-10-24 04:01:00',0,'这是好意思','',NULL,'','CN'),(2,'Excuse me. My name is Richard Stewart','',NULL,'','EN',NULL,NULL,NULL,NULL,NULL,NULL,'2016-10-25 21:04:16',3,'对不起，我叫Richard Stewart','',NULL,'','CN'),(3,'Whether you like it or not, we use numbers every day. ','',NULL,'','EN',NULL,NULL,NULL,NULL,NULL,NULL,'2016-10-25 21:37:54',4,'你喜歡不喜歡這個， 每天我們用','',NULL,'','CN'),(4,'Test English','',NULL,'','EN',NULL,NULL,NULL,NULL,NULL,NULL,'2016-10-27 18:42:53',1,'','',NULL,'German Sentence','GE'),(5,'Test','',NULL,'','EN',NULL,NULL,NULL,NULL,NULL,NULL,'2016-12-06 11:17:15',4,'Test11','',NULL,'','CN');
