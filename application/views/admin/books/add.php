    <div class="page-content">
        ...
        if(isset($flash_message)){
          if($flash_message == TRUE)
          {
            echo '<div class="alert alert-success">';
              ...
              echo '<strong>Well done!</strong> New book has been added successfully.';
            echo '</div>';       
          }else{
      ...
      echo form_open_multipart('admin/books/add/'.$this->uri->segment(4), $attributes);
      ?>
        <div class="row">
          <div class="col-md-6">
            <div class="grid simple">
              <div class="grid-header">
                <h2 class="grid-title">Book Information</h2>
              </div>
              <div class="grid-body">
